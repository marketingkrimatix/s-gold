      ...
      <section className="bg-[var(--color-section-bg)] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-text-primary sm:text-4xl">About SGold</h2>
            ...
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
              <div className="flex flex-col">
                <dt className="text-base font-semibold leading-7 text-text-primary">
                  <div className="mb-6 flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-r from-[#F6E7A1] via-[#E9C962] to-[#D4AF37]">
                ...
                <dd className="mt-1 flex flex-auto flex-col text-base leading-7 text-text-secondary">
                  <p className="flex-auto">
                    SGold was established 10 years ago in Hyderabad and has since become a trusted name in the gold buying market.
              ...
              <div className="flex flex-col">
                ...
                <dd className="mt-1 flex flex-auto flex-col text-base leading-7 text-text-secondary">
                  <p className="flex-auto">
                    ...
                    At SGold Finance, we buy your gold assets and pay instant cash. We also help our customers
