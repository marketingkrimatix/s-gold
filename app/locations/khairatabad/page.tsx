...
export default function KhairatabadLocationPage() {
  const steps = [
    { title: "Visit our Branch", desc: "Visit our Khairatabad branch with your gold for a transparent evaluation." },
    { title: "Instant Testing", desc: "Get purity checked using advanced XRF testing methods right in front of you." },
    { title: "Live Rate Quote", desc: "Receive a valuation based on the live gold market rate with zero hidden charges." },
    { title: "Instant Payment", desc: "Get paid immediately via Cash, UPI, or Bank Transfer (IMPS/RTGS)." }
  ];
  ...
  const nearbyAreas = ["Somajiguda", "Lakdikapul", "Punjagutta", "Ameerpet", "Masab Tank"];
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "No purchase bill is required. You only need a valid government-issued ID (Aadhaar Card, PAN Card, or Passport) for KYC verification."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, we buy all types of gold including old jewellery, broken ornaments, and scrap gold, regardless of its condition."
    }
  ];
    ...
    <main className="min-h-screen bg-background text-text-primary">
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <h2 className="text-3xl font-bold text-text-primary">Why Sell Gold in Khairatabad?</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              Khairatabad is one of the busiest and most accessible areas of Hyderabad. Conveniently located opposite SBI Bank, our branch serves customers from Somajiguda, Lakdikapul, Punjagutta, and nearby central Hyderabad areas.
            </p>
            <ul className="mt-8 space-y-4">
              {[
                "Emergency financial needs",
                "Upgrading old jewellery",
                "Releasing pledged gold from banks",
                "Liquidating unused gold assets"
              ].map((item) => (
          ...
          <div className="rounded-[2.5rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
            ...
            <div className="mt-8 space-y-6">
              {[
                ...
                "Transparent weight & purity testing",
                "Instant cash or bank transfer",
                "Opposite SBI Bank (easy to find)"
              ].map((point, idx) => (
      ...
      <section className="bg-[var(--color-section-bg)] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-text-primary">Our Gold Buying Services</h2>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl font-bold text-text-primary">Nearby Areas We Serve</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              Our Khairatabad branch is centrally located and easily accessible for residents across Hyderabad, ensuring you don't have to travel far for the best gold rates.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="rounded-[3rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-text-tertiary">
                      Plot No. 6-2-198/3, Siva Sai Nilayam, Khairatabad, Hyderabad. <br />
                      <strong>Landmark:</strong> Opposite SBI Bank
                    </p>
                  </div>
                </div>
            ...
            <div className="h-[400px] overflow-hidden rounded-[2rem] border border-card-border shadow-inner">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3807.012582478871!2d78.46024709999999!3d17.4111838!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb97ea5961cf6d%3A0xb94ad77d31eab8b9!2sV-Gold!5e0!3m2!1sen!2sin!4v1776935238051!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
      ...
      {/* FAQ Section */}
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <h2 className="text-3xl font-bold text-center text-text-primary mb-12">FAQs – Selling Gold in Khairatabad</h2>
