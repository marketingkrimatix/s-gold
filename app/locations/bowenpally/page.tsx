...
export default function BowenpallyLocationPage() {
  const steps = [
    { title: "Ultrasonic Cleaning", desc: "Ornaments accumulate dirt/sweat over time. We use ultrasonic waves to ensure 100% metal weight, no debris." },
    { title: "Laser Purity Mapping", desc: "XRF Karatmeters scan through jewelry, identifying inner purity without melting—essential for antique or inherited gold." },
    { title: "Digital Weight Verification", desc: "ISO-certified scales provide accuracy up to three decimal places. We ensure you benefit from every milligram." },
    { title: "Net Gold Valuation", desc: "Professional density-check methods accurately subtract stone or enamel weight, paying for precious metal at live rates." },
    { title: "Secure Payment", desc: "Funds are transferred via IMPS, RTGS, or UPI instantly. You receive a professional digital invoice for legal documentation." }
  ];
  ...
  const services = [
    ...
    "Cantonment Area Service Hub"
  ];

  const nearbyAreas = ["Old Bowenpally", "New Bowenpally", "Kompally", "Alwal", "Jeedimetla", "Diamond Point"];
  ...
  const faqs = [
    ...
    {
      question: "Do you buy gold with heavy stone work?",
      answer: "Yes, we buy all types of jewelry. We use scientific density-check methods to subtract the weight of stones and pay you for the actual gold content."
    },
    {
      question: "Is it safe to carry gold to your branch?",
      answer: "Our Bowenpally branch is in a highly professional environment with 24/7 CCTV surveillance and private cabins for high-value transactions."
    },
    {
      question: "Can I get my gold back if I don’t like the price?",
      answer: "Yes, our valuation is 100% free and no-obligation. If you choose not to sell, you take your gold back immediately, exactly as it was."
    }
  ];
  ...
  return (
    <main className="min-h-screen bg-background text-text-primary">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <ul className="mt-8 space-y-4">
              {[
                "Scientific accuracy over traditional 'gut feeling'",
                "Non-destructive purity reports for peace of mind",
                "Strategic location near Bowenpally X Roads",
                "Immediate payments via IMPS, RTGS, or UPI"
              ].map((item) => (
          ...
          <div className="rounded-[2.5rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
            <h3 className="text-2xl font-bold text-text-primary">Serving the Gateway to the North</h3>
            <div className="mt-8 space-y-6">
              {[
                "Ideal for Kompally & Jeedimetla residents",
                "Trusted professional alternative for Alwal",
                "Secure environment for military families",
                "Easy highway access from Medchal",
                "Transparent valuation in less than 20 minutes"
              ].map((point, idx) => (
      ...
      <section className="bg-[var(--color-section-bg)] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-text-primary">Premium Gold Services</h2>
            <p className="mt-4 text-text-secondary">Unlocking financial flexibility for Bowenpally residents.</p>
          </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-text-primary">Our 5-Step Transparency Protocol</h2>
            <p className="mt-4 text-text-secondary">Seeing is believing – every step happens in your presence.</p>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl font-bold text-text-primary">Serving North Secunderabad</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              Our Bowenpally branch is the central hub for residents of Old and New Bowenpally, Kompally, Alwal, and military personnel from the Cantonment area.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="rounded-[3rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-text-tertiary">
                      Shop no. 10, 1st Floor, Above Mahaveera Tiffins & Meals, PNR Complex, Opp. Kotak Mahindra Bank, Thadbun, Bowenpally, Hyderabad, Telangana 500011. <br />
                      <strong>Landmark:</strong> Near Bowenpally X Roads
                    </p>
                  </div>
                </div>
            ...
            <div className="h-[400px] overflow-hidden rounded-[2rem] border border-card-border shadow-inner">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3805.567890123456!2d78.4812345!3d17.4712345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDI4JzQwLjQiTiA3OMswMjgnNDAuNCJF!5e0!3m2!1sen!2sin!4v1713360000000!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
      ...
      {/* FAQ Section */}
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <h2 className="text-3xl font-bold text-center text-text-primary mb-12">FAQs – Selling Gold in Bowenpally</h2>
