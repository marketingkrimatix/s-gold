...
export default function NallagandlaLocationPage() {
  const steps = [
    { title: "Walk-in Visit", desc: "Visit our Nallagandla branch with your gold at your convenience." },
    { title: "Advanced Purity Check", desc: "We use scientific methods for non-destructive purity testing." },
    { title: "Real-time Pricing", desc: "Price calculation based on current live market rates, no guesswork." },
    { title: "Instant Payment", desc: "Get paid instantly through Cash, UPI, or Bank Transfer in 15-20 minutes." }
  ];

  const services = [
    "Old Gold Jewellery Buyers",
    "Broken Gold Ornaments",
    "Gold Coin Buyers",
    "Scrap Gold Purchasing",
    "Professional Valuation"
  ];

  const nearbyAreas = ["Tellapur", "Lingampally", "BHEL", "Gachibowli", "Kondapur"];

  const faqs = [
    {
      question: "Why should Nallagandla residents choose selling over a gold loan?",
      answer: "For modern professionals, selling is often smarter than a loan. it provides immediate liquidity for investments without interest rates, processing fees, or debt cycles."
    },
    {
      question: "I’ve lost my original jewelry invoice; can I still sell my gold here?",
      answer: "Yes, you can sell your gold without a purchase bill. A valid government ID (Aadhaar, PAN, etc.) is sufficient for our secure process."
    },
    {
      question: "How do you ensure I get the best price for my gold in this area?",
      answer: "We use live market pricing and transparent evaluation. Every milligram is accounted for using professional weighing and purity testing."
    },
    {
      question: "Is the process fast enough for someone on a tight work schedule?",
      answer: "Absolutely. Our entire process—from testing to payment—usually takes only 15–20 minutes, perfect for busy IT professionals."
    }
  ];
    ...
    <main className="min-h-screen bg-background text-text-primary">
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <h2 className="text-3xl font-bold text-text-primary">A Smart Financial Move</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              In a locality like Nallagandla, gold is no longer just a stored asset—it is a financial resource. Residents here prefer nearby, fast services that are professionally managed and transparent.
            </p>
            <ul className="mt-8 space-y-4">
              {[
                "Reallocating funds into investments",
                "Managing planned expenses",
                "Upgrading lifestyle or assets",
          ...
          <div className="rounded-[2.5rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
            <h3 className="text-2xl font-bold text-text-primary">Ideal for IT Professionals</h3>
            <div className="mt-8 space-y-6">
              {[
                "Quick and hassle-free evaluation",
                "Transparent pricing with no guesswork",
                "Professionally managed branch experience",
                "No hidden deductions or fees",
                "Serving Tellapur & Serilingampally"
              ].map((point, idx) => (
      ...
      <section className="bg-[var(--color-section-bg)] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-text-primary">What We Buy</h2>
            <p className="mt-4 text-text-secondary">We accept all types of gold regardless of condition.</p>
          </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-text-primary">Time-Saving 4-Step Process</h2>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl font-bold text-text-primary">Serving the Growing Hub</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              Nallagandla’s infrastructure makes it a convenient option for residents from Tellapur, Lingampally, BHEL, and Gachibowli who seek professional gold buying services.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="rounded-[3rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-text-tertiary">
                      H.No. 5-5, 1st Floor, Adarsh Nagar Colony, Serilingampally Mandal, Hyderabad. <br />
                      <strong>Landmark:</strong> Opposite Sancta Maria International School
                    </p>
                  </div>
                </div>
            ...
            <div className="h-[400px] overflow-hidden rounded-[2rem] border border-card-border shadow-inner">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3806.123456789012!2d78.3112345!3d17.4612345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDI3JzQwLjQiTiA3OMKwMTgnNDAuNCJF!5e0!3m2!1sen!2sin!4v1713360000000!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
      ...
      {/* FAQ Section */}
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <h2 className="text-3xl font-bold text-center text-text-primary mb-12">FAQs – Selling Gold in Nallagandla</h2>
