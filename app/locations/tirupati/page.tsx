...
export default function TirupatiLocationPage() {
  const steps = [
    { title: "Visit or Appointment", desc: "Visit our Tirupati store or book an appointment for a doorstep evaluation." },
  ...
  const locations = ["Tirupati City", "Renigunta", "Tiruchanur", "Chandragiri"];

  const testimonials = [
    { name: "John", text: "Best gold buyers in Tirupati. Got more price than other shops!" },
    ...
    <main className="min-h-screen bg-background text-text-primary">
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <h2 className="text-3xl font-bold text-text-primary">Sell Your Gold in Tirupati with Trust & Transparency</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              At S Gold, we offer the best value for your gold in Tirupati. Whether it’s old jewellery, broken ornaments, or unused gold, we ensure:
            </p>
          ...
          <div className="rounded-[2.5rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
            <h3 className="text-2xl font-bold text-text-primary">Why Choose S Gold in Tirupati?</h3>
            <div className="mt-8 space-y-6">
              {[
                "Highest gold rate in Tirupati",
      ...
      <section className="bg-[var(--color-section-bg)] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-text-primary">Our Gold Buying Services in Tirupati</h2>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl font-bold text-text-primary">Trusted Gold Buyers Near Tirupati</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              Looking for reliable gold buyers near Tirupati? S Gold provides a secure and hassle-free gold selling experience. Our expert team ensures accurate valuation using advanced technology.
            </p>
            <p className="mt-4 text-text-tertiary font-medium">We serve customers across Tirupati and surrounding regions.</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="rounded-[3rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              <h2 className="text-3xl font-bold text-text-primary">Ready to Sell Your Gold in Tirupati?</h2>
              ...
              <div className="mt-10 space-y-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-text-tertiary">
                      Jagjeevan Ram Park, 19-12/1-6, Bairagipatteda Rd, beside Sri Padmavathi Foods, opp. Sri Babu, Kesavayana Gunta, Bairagi patteda, Tirupati, Andhra Pradesh 517501
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-4">
                  <Link href="tel:+919996909999" className="inline-flex rounded-full bg-brand-gold px-8 py-3 text-sm font-bold text-[#2A0848] shadow-lg transition hover:scale-105">
                    Call Now
                  </Link>
