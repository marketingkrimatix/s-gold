        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              At SGold, we offer the best value for your gold in Tirupati. Whether it’s old jewellery, broken ornaments, or unused gold, we ensure:
            </p>
          ...
          <div className="rounded-[2.5rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
            <h3 className="text-2xl font-bold text-text-primary">Why Choose SGold in Tirupati?</h3>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              Looking for reliable gold buyers near Tirupati? SGold provides a secure and hassle-free gold selling experience. Our expert team ensures accurate valuation using advanced technology.
            </p>
