...
export default function KarwanLocationPage() {
  ...
  const faqs = [
    {
      question: "Where exactly is the SGold branch in Karwan?",
    ...
    <main className="min-h-screen bg-background text-text-primary">
      ...
      <section className="relative px-6 py-20 lg:px-8">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg text-text-secondary">
            Bringing transparency to a historic neighborhood. SGold Karwan offers a professional, corporate environment where your assets are valued with scientific precision.
          </p>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              While traditional goldsmiths are part of Karwan's charm, they often lack the technology for accurate valuation. SGold replaces the 'deduction culture' with scientific mapping and molecular-level scanning.
            </p>
      ...
      <section className="bg-[var(--color-section-bg)] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-text-primary">The SGold 5-Point Scientific Process</h2>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="rounded-[3rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              <h2 className="text-3xl font-bold text-text-primary">Visit SGold Karwan Today</h2>
