...
export default function KukatpallyLocationPage() {
  const steps = [
    { title: "Visit or Appointment", desc: "Visit our Kukatpally store or book an appointment for a doorstep evaluation." },
    { title: "Instant Testing", desc: "Get your gold tested using advanced XRF technology right in front of you." },
    { title: "Live Market Rate", desc: "Get a valuation based on current live gold market trends, ensuring best value." },
    { title: "Instant Payment", desc: "Receive your payment immediately via Cash, UPI, or Bank Transfer." }
  ];
  ...
  const nearbyAreas = ["KPHB Colony", "JNTU", "Moosapet", "Vivekananda Nagar"];

  const faqs = [
    {
      question: "Which is the best place to sell gold near KPHB Colony in Kukatpally?",
      answer: "If you are near KPHB Colony or JNTU, SGold offers transparent pricing, live gold rate evaluation, and quick payment, making it a reliable choice."
    },
    {
      question: "Can I sell gold near JNTU Kukatpally without traveling far?",
      answer: "Yes, our branch is conveniently located near the major Kukatpally junction, easily reachable from KPHB Road and surrounding areas."
    },
    {
      question: "Do gold buyers in Kukatpally check purity in front of customers?",
      answer: "Yes, at SGold, we use advanced XRF testing machines to check the purity of your gold right in front of you for 100% transparency."
    },
    {
      question: "Can I sell small gold items like rings or chains in Kukatpally?",
      answer: "Absolutely. We buy all quantities of gold, from small rings and chains to larger ornaments and sets."
    }
  ];
    ...
    <main className="min-h-screen bg-background text-text-primary">
      ...
      <section className="relative px-6 py-20 lg:px-8">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-6 text-4xl font-bold leading-tight tracking-tight text-text-primary lg:text-5xl">
            Sell Gold in Kukatpally – <br />
            <span className="bg-gradient-to-r from-[#F6E7A1] via-[#E9C962] to-[#D4AF37] bg-clip-text text-transparent">
              Quick & Convenient for KPHB Residents.
            </span>
          </h1>
          <p className="mt-6 text-lg text-text-secondary">
            In a fast-paced area like Kukatpally, convenience plays a major role. SGold provides a simple, nearby option for residents of KPHB, JNTU, and surrounding neighborhoods.
          </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <h2 className="text-3xl font-bold text-text-primary">Convenience-First Gold Selling</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              Kukatpally is one of the most active residential hubs in Hyderabad. Residents prefer nearby gold buyers to save time and fit transactions into their busy daily schedules.
            </p>
            <ul className="mt-8 space-y-4">
              {[
                "Quick evaluation within minutes",
          ...
          <div className="rounded-[2.5rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
            <h3 className="text-2xl font-bold text-text-primary">Kukatpally Branch Details</h3>
            <div className="mt-8 space-y-6">
              {[
                "Easy main-road access",
                "Near major Kukatpally junction",
                "Reachable from KPHB Road",
                "Walk-in friendly atmosphere",
                "Serving KPHB, JNTU & Moosapet"
              ].map((point, idx) => (
      ...
      <section className="bg-[var(--color-section-bg)] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-text-primary">Local Lifestyle & Trends</h2>
            <p className="mt-4 text-text-secondary max-w-2xl mx-auto">
              In Kukatpally, gold is treated as a usable asset. Many residents sell unused jewelry to manage short-term expenses or upgrade to new designs.
            </p>
          </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-text-primary">The SGold Selling Process</h2>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl font-bold text-text-primary">Areas We Serve</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              Kukatpally serves as a convenient hub for residents from KPHB Colony, JNTU, Moosapet, and Vivekananda Nagar, providing easy access to professional gold buying services.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="rounded-[3rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              <h2 className="text-3xl font-bold text-text-primary">Visit SGold Kukatpally Today</h2>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-text-tertiary">
                      H.No. 5-1-27/2, 1st Floor, Near BJP Office, Beside Crystal Beauty and Wellness Spa, Kukatpally, Hyderabad. <br />
                      <strong>Landmark:</strong> Opposite Reliance Digital
                    </p>
                  </div>
                </div>
            ...
            <div className="h-[400px] overflow-hidden rounded-[2rem] border border-card-border shadow-inner">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3805.234567890123!2d78.3912345!3d17.4812345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDI4JzQwLjQiTiA3OMKwMjMnNDAuNCJF!5e0!3m2!1sen!2sin!4v1713360000000!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
      ...
      {/* FAQ Section */}
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <h2 className="text-3xl font-bold text-center text-text-primary mb-12">FAQs – Selling Gold in Kukatpally</h2>
