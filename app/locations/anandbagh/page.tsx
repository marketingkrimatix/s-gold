...
export default function AnandbaghLocationPage() {
  const steps = [
    { title: "Preliminary Cleaning", desc: "Jewelry worn over years can collect wax or dirt. We use ultrasonic cleaners to ensure 100% accurate weight." },
    { title: "High-Precision Weighing", desc: "We use ISO-certified digital scales calibrated daily. Every milligram matters for your true valuation." },
    { title: "XRF Laser Purity Analysis", desc: "Our Karatmeter uses non-destructive X-rays to scan metal, identifying exact percentages of gold, silver, and copper." },
    { title: "Net Gold Calculation", desc: "Professional density-check methods accurately subtract stone or enamel weight. You're paid for the net gold content." },
    { title: "Instant Fund Transfer", desc: "Once you approve the quote based on Live Market Rates, funds are yours via Cash, UPI, or IMPS within minutes." }
  ];

  const services = [
    "Old Gold Jewellery Buyers",
    "High-Precision XRF Testing",
    "Digital Weight Verification",
    "Net Gold Valuation",
    "Instant Fund Settlement"
  ];

  const nearbyAreas = ["Malkajgiri", "Safilguda", "Vinayak Nagar", "Moula Ali", "Neredmet", "RK Puram"];
  ...
  const faqs = [
    ...
    {
      question: "Can I sell old, broken, or inherited jewelry?",
      answer: "Yes, we buy gold in any form—whether it's old family heirlooms, broken chains, or inherited ornaments. Our XRF testing identifies the pure metal content instantly."
    },
    {
      question: "What documents should I bring to the Anandbagh branch?",
      answer: "You only need a valid government-issued ID proof (Aadhaar, PAN, or Passport) to complete the legal documentation for your transaction."
    },
    {
      question: "How long does the entire process take?",
      answer: "Our streamlined process—from cleaning and testing to payment—usually takes about 15 to 20 minutes."
    }
  ];
  ...
  return (
    <main className="min-h-screen bg-background text-text-primary">
      ...
      <section className="relative px-6 py-20 lg:px-8">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-6 text-4xl font-bold leading-tight tracking-tight text-text-primary lg:text-5xl">
            Sell Gold in Anandbagh – <br />
            <span className="bg-gradient-to-r from-[#F6E7A1] via-[#E9C962] to-[#D4AF37] bg-clip-text text-transparent">
              Trusted & Transparent Gold Buying.
            </span>
          </h1>
          <p className="mt-6 text-lg text-text-secondary">
            The gold standard for Anandbagh and Malkajgiri residents. Convert your 'rainy day' fund or legacy assets into maximum market value with city-best transparency.
          </p>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <ul className="mt-8 space-y-4">
              {[
                "No hidden 'wastage' or 'melting loss' charges",
                "99.9% accurate digital purity reports",
                "Pricing based on Live Hyderabad market rates",
                "Secure, private environment for high-value transactions"
              ].map((item) => (
          ...
          <div className="rounded-[2.5rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
            <h3 className="text-2xl font-bold text-text-primary">Financial Planning Excellence</h3>
            <div className="mt-8 space-y-6">
              {[
                "Unlock funds for educational milestones",
                "Finance home renovations & upgrades",
                "Consolidate high-interest debt efficiently",
                "Convert 'dead gold' into active investments",
                "Serving Malkajgiri, Safilguda & Moula Ali"
              ].map((point, idx) => (
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              Anandbagh is the central hub for Malkajgiri, Safilguda, and surrounding areas. We provide professional gold buying services that are accessible and highly trusted by the local community.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="rounded-[3rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-text-tertiary">
                      H.No. 23-216, 1st Floor, Above Optical Planet, RK Nagar, Anand Bagh X Road, Malkajgiri, Hyderabad, Telangana 500047. <br />
                      <strong>Landmark:</strong> Near Anandbagh Crossroads
                    </p>
                  </div>
                </div>
            ...
            <div className="h-[400px] overflow-hidden rounded-[2rem] border border-card-border shadow-inner">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3805.567890123456!2d78.5312345!3d17.4512345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDI3JzQwLjQiTiA3OMswMzEnNDAuNCJF!5e0!3m2!1sen!2sin!4v1713360000000!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
      ...
      {/* FAQ Section */}
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <h2 className="text-3xl font-bold text-center text-text-primary mb-12">FAQs – Selling Gold in Anandbagh</h2>
