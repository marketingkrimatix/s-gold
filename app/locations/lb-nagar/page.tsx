  ...
  const faqs = [
    {
      ...
      answer: "Gold prices change daily based on market conditions. At SGold LB Nagar, gold is evaluated using the live market rate at the time of testing."
    },
    {
    ...
    <main className="min-h-screen bg-background text-text-primary">
      ...
      <section className="relative px-6 py-20 lg:px-8">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg text-text-secondary">
            A trusted gold-buying landmark in East Hyderabad’s busiest hub. SGold LB Nagar offers a transparent, secure, and hassle-free experience for residents and commuters.
          </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="rounded-[3rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              <h2 className="text-3xl font-bold text-text-primary">Visit SGold LB Nagar Today</h2>
