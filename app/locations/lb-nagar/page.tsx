...
export default function LBNagarLocationPage() {
  const steps = [
    { title: "Visit Branch", desc: "Visit our LB Nagar branch with your gold jewellery and valid ID proof for a professional welcome." },
    { title: "Transparent Evaluation", desc: "Gold purity and weight are tested in full view using standardised equipment for complete transparency." },
  ...
  const services = [
    ...
    "East Hyderabad Commercial Hub"
  ];

  const nearbyAreas = ["Dilsukhnagar", "Vanasthalipuram", "Nagole", "Kothapet", "Chaitanyapuri", "Champapet"];

  const faqs = [
    {
      question: "What is today’s gold rate in LB Nagar?",
      answer: "Gold prices change daily based on market conditions. At S-Gold LB Nagar, gold is evaluated using the live market rate at the time of testing."
    },
    {
    ...
    {
      question: "Is instant cash available at V-Gold LB Nagar?",
    ...
    <main className="min-h-screen bg-background text-text-primary">
      ...
      <section className="relative px-6 py-20 lg:px-8">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg text-text-secondary">
            A trusted gold-buying landmark in East Hyderabad’s busiest hub. S-Gold LB Nagar offers a transparent, secure, and hassle-free experience for residents and commuters.
          </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <h2 className="text-3xl font-bold text-text-primary">Trusted Gold Buyers in LB Nagar</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              LB Nagar is a major junction and commercial hub. We have earned the trust of customers by offering fair market-based pricing, clear purity testing, and professional service with zero hidden charges.
            </p>
            <ul className="mt-8 space-y-4">
              {[
                "Excellent connectivity via LB Nagar Metro",
                "Professional and government-registered gold buyers",
                "Pricing based strictly on live gold market rates",
                "Clear purity testing in front of the customer"
              ].map((item) => (
          ...
          <div className="rounded-[2.5rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
            <h3 className="text-2xl font-bold text-text-primary">LB Nagar Branch Highlights</h3>
            <div className="mt-8 space-y-6">
              {[
                "Prime location near LB Nagar Main Junction",
                "Ideal for Vanasthalipuram & Nagole residents",
                "Professional and trained valuation staff",
                "Same-day settlement via IMPS/NEFT/UPI",
                "Secure environment for safe transactions"
              ].map((point, idx) => (
      ...
      <section className="bg-[var(--color-section-bg)] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-text-secondary">Complete gold liquidation solutions in East Hyderabad.</p>
          </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-text-primary">Your Experience at LB Nagar Branch</h2>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl font-bold text-text-primary">Serving the Commercial Junction</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              Our LB Nagar branch is the primary destination for residents of Vanasthalipuram, Nagole, and Kothapet seeking honest gold buying services with professional standards.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="rounded-[3rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              <h2 className="text-3xl font-bold text-text-primary">Visit S-Gold LB Nagar Today</h2>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-text-tertiary">
                      Plot no. 11-14-518/1, 201 2nd Floor, Amritha Pride, Siri Nagar Colony, Siris Road, LB Nagar, Hyderabad, Telangana 500074. <br />
                      <strong>Landmark:</strong> Near LB Nagar Metro Station
                    </p>
                  </div>
                </div>
            ...
            <div className="h-[400px] overflow-hidden rounded-[2rem] border border-card-border shadow-inner">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3807.567890123456!2d78.5512345!3d17.3512345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDIxJzQwLjQiTiA3OMswMzMnNDAuNCJF!5e0!3m2!1sen!2sin!4v1713360000000!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
      ...
      {/* FAQ Section */}
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <h2 className="text-3xl font-bold text-center text-text-primary mb-12">FAQs – Selling Gold in LB Nagar</h2>
