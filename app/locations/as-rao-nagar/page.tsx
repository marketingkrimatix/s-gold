...
export default function ASRaoNagarLocationPage() {
  const steps = [
    { title: "Reception & ID Verification", desc: "Our staff greets you and verifies your Aadhaar or PAN card to ensure legal documentation." },
    { title: "Cleaning & Weighing", desc: "Gold is cleaned of dust or wax to ensure 100% accurate measurement on ISO-certified scales." },
    { title: "Laser Purity Testing", desc: "German XRF technology analyzes your gold in less than 60 seconds without a single scratch." },
    { title: "Instant Settlement", desc: "Receive a computer-generated quote based on live rates and get paid via Cash, UPI, or IMPS/RTGS." }
  ];
  ...
  const nearbyAreas = ["Sainikpuri", "Kapra", "Vayupuri", "Yapral", "Dammaiguda", "Moula Ali", "Kushaiguda"];

  const faqs = [
    {
      question: "I live in Yapral. Is it worth driving to AS Rao Nagar to sell?",
      answer: "Absolutely. Our XRF testing and zero-deduction policy often provide a significantly higher payout that covers your travel time many times over."
    },
    {
      question: "Can I sell gold that was purchased in another state or country?",
      answer: "Yes, we buy gold regardless of where it was purchased. Our scientific testing identifies the exact purity of any gold ornament."
    },
    {
    ...
    },
    {
      ...
      answer: "Our valuation is completely free and no-obligation. If you're not satisfied, you can take your gold back exactly as it was."
    }
  ];
  ...
  return (
    <main className="min-h-screen bg-background text-text-primary">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <ul className="mt-8 space-y-4">
              {[
                "100% Non-destructive laser testing",
                "ISO-certified high-precision scales",
                "Pricing based on Live Hyderabad market rate",
                "No hidden 'wastage' or 'making' deductions"
              ].map((item) => (
          ...
          <div className="rounded-[2.5rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
            ...
            <div className="mt-8 space-y-6">
              {[
                ...
                "Open evaluation policy: see every step",
                "Trusted by retired defense personnel",
                "Strategic solution for modern families",
                "Near major AS Rao Nagar junction"
              ].map((point, idx) => (
      ...
      <section className="bg-[var(--color-section-bg)] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-text-primary">Your 15-Minute Experience</h2>
            <p className="mt-4 text-text-secondary">Quick, honest, and designed for your convenience.</p>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl font-bold text-text-primary">Serving North Hyderabad</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              AS Rao Nagar is the heart of a well-established residential ecosystem. We serve families from Sainikpuri, Kapra, Yapral, and ECIL who value trust and precision.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="rounded-[3rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-text-tertiary">
                      1-1-261/119, Srinivas Nagar, Kapra, ECIL Post, Hyderabad, Telangana 500062. <br />
                      <strong>Landmark:</strong> Near AS Rao Nagar Junction
                    </p>
                  </div>
                </div>
            ...
            <div className="h-[400px] overflow-hidden rounded-[2rem] border border-card-border shadow-inner">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3805.123456789012!2d78.5412345!3d17.4712345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDI4JzQwLjQiTiA3OMKwMzInNDAuNCJF!5e0!3m2!1sen!2sin!4v1713360000000!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
      ...
      {/* FAQ Section */}
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <h2 className="text-3xl font-bold text-center text-text-primary mb-12">FAQs – Selling Gold in AS Rao Nagar</h2>
