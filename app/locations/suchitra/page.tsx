...
export default function SuchitraLocationPage() {
  const steps = [
    { title: "Visit Branch", desc: "Visit our Suchitra branch with your gold jewellery and valid ID proof for a professional welcome." },
  ...
  const services = [
    ...
    "North Hyderabad Service Hub"
  ];

  const nearbyAreas = ["Kompally", "Bowenpally", "Jeedimetla", "Alwal", "Balanagar"];
    ...
    <main className="min-h-screen bg-background text-text-primary">
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <h2 className="text-3xl font-bold text-text-primary">Transparent Gold Buyers in Suchitra</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              Suchitra is a rapidly growing locality. We have built strong customer trust by maintaining complete clarity throughout the gold selling process, ensuring confidence before confirming any transaction.
            </p>
            <ul className="mt-8 space-y-4">
              {[
                "Excellent connectivity via Medchal Road",
                "Professional and government-registered gold buyers",
                "Pricing based strictly on live gold market rates",
                "No hidden charges or forced pressure selling"
              ].map((item) => (
          ...
          <div className="rounded-[2.5rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
            <h3 className="text-2xl font-bold text-text-primary">Suchitra Branch Highlights</h3>
            <div className="mt-8 space-y-6">
              {[
                "Prime location near Suchitra Circle",
      ...
      <section className="bg-[var(--color-section-bg)] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-text-secondary">Complete gold liquidation solutions in North Hyderabad.</p>
          </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-text-primary">Your Experience at Suchitra Branch</h2>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              Our Suchitra branch is the primary destination for residents of Kompally, Bowenpally, and Jeedimetla seeking honest gold buying services with professional standards.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="rounded-[3rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-text-tertiary">
                      H No. 6-27, Vennelagudda, Next to Green Trends Building, Suchitra Road, Quthubullapur, Hyderabad, Telangana 500067. <br />
                      <strong>Landmark:</strong> Near Suchitra Circle
                    </p>
                  </div>
                </div>
            ...
            <div className="h-[400px] overflow-hidden rounded-[2rem] border border-card-border shadow-inner">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3804.567890123456!2d78.4712345!3d17.5112345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDMwJzQwLjQiTiA3OMswMjgnNDAuNCJF!5e0!3m2!1sen!2sin!4v1713360000000!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
      ...
      {/* FAQ Section */}
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <h2 className="text-3xl font-bold text-center text-text-primary mb-12">FAQs – Selling Gold in Suchitra</h2>
