...
export default function KarimnagarLocationPage() {
  const steps = [
    { title: "Visit or Appointment", desc: "Visit our Karimnagar store or book an appointment for a doorstep evaluation." },
  ...
  const locations = ["Mukarampura", "Vavilalapally", "Chintakunta", "Hussainipura"];

  const testimonials = [
    { name: "John", text: "Best gold buyers in Karimnagar. Got more price than other shops!" },
      ...
      <section className="bg-[var(--color-section-bg)] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-text-primary">Our Gold Buying Services in Karimnagar</h2>
          </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-text-tertiary">
                      Shop No. 2, 1St Floor, H. No. 7-1-36, above Kotak Mahindra Bank, opp. ICICI Bank, Mankamma Thota, Karimnagar, Telangana 505001
                    </p>
                  </div>
                </div>
