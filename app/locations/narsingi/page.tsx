...
export default function NarsingiLocationPage() {
  const steps = [
    { title: "Ultrasonic Cleaning", desc: "Gold accumulated with oils or wax over decades is cleaned via ultrasonic technology for 100% metal weight." },
    { title: "Non-Destructive Laser Testing", desc: "Our Karatmeter scans through ornaments to identify purity at a molecular level without filing, scratching, or melting." },
    { title: "Precision Digital Weighing", desc: "We use ISO-certified scales accurate up to three decimal places. Every milligram is accounted for in your final quote." },
    { title: "Net Weight Adjustment", desc: "Scientific density-testing methods accurately subtract the weight of stones and wax for fair net gold payment." },
    { title: "Instant Settlement", desc: "Once the quote is approved based on Live Market Rates, funds are transferred via IMPS, RTGS, or UPI instantly." }
  ];

  const services = [
    "Old Gold Jewellery Buyers",
    "Scientific Purity Mapping",
    "ISO-Certified Accurate Weighing",
    "Instant High-Value Settlement",
    "Confidential & Private Cabins"
  ];

  const nearbyAreas = ["Kokapet", "Puppalguda", "Manikonda", "Gandipet", "Financial District", "Tellapur"];
  ...
  const faqs = [
    ...
    {
      question: "Do you buy white gold or diamond-studded jewelry?",
      answer: "Yes, we buy all types of gold jewelry. We use professional density-check methods to subtract stone weight and pay for the actual gold content."
    },
    {
      question: "Is the testing process safe for my heirloom jewelry?",
      answer: "Absolutely. Our German XRF laser testing is 100% non-destructive, ensuring your jewelry's integrity is maintained throughout the process."
    },
    {
      question: "Can I get an instant bank transfer for a large amount?",
      answer: "Yes, we facilitate immediate IMPS and RTGS transfers, ensuring funds are in your account before you leave our branch."
    }
  ];
    ...
    <main className="min-h-screen bg-background text-text-primary">
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <h2 className="text-3xl font-bold text-text-primary">Modern Standards for a Modern Hyderabad</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              Narsingi is home to a new generation of professionals who value speed, efficiency, and transparency. We replace traditional guesswork with German XRF Laser Analyzers and ISO-certified digital scales.
            </p>
            <ul className="mt-8 space-y-4">
              {[
                "Strategic location near the ORR and Financial District",
                "Non-destructive scientific purity reports",
                "Secure environment with exclusive private cabins",
                "Pricing based strictly on live gold market rates"
              ].map((item) => (
          ...
          <div className="rounded-[2.5rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
            <h3 className="text-2xl font-bold text-text-primary">Strategic Financial Planning</h3>
            <div className="mt-8 space-y-6">
              {[
                "Fund luxury real estate upgrades instantly",
                "Diversify portfolios into high-yield assets",
                "Access interest-free liquidity for global goals",
                "Liquidate 'dead gold' for active investments",
                "Serving Kokapet, Puppalguda & Manikonda"
              ].map((point, idx) => (
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl font-bold text-text-primary">Serving the 'New West' Hub</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              Our Narsingi branch is the central hub for Kokapet, Puppalguda, Gandipet, and the Financial District, providing professional gold exchange near luxury residential clusters.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="rounded-[3rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-text-tertiary">
                      Shop no 2, 1st Floor, Narsingi X Road, Manchirevula, Opp. Muthoot Fincorp, Hyderabad, Telangana 500075. <br />
                      <strong>Landmark:</strong> Near Narsingi X Roads
                    </p>
                  </div>
                </div>
            ...
            <div className="h-[400px] overflow-hidden rounded-[2rem] border border-card-border shadow-inner">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3806.567890123456!2d78.3512345!3d17.3912345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDIzJzQwLjQiTiA3OMswMjEnNDAuNCJF!5e0!3m2!1sen!2sin!4v1713360000000!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
      ...
      {/* FAQ Section */}
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <h2 className="text-3xl font-bold text-center text-text-primary mb-12">FAQs – Selling Gold in Narsingi</h2>
