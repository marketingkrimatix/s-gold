...
export default function VanasthalipuramLocationPage() {
  const steps = [
    { title: "Identity Verification", desc: "We follow strict KYC norms with Aadhaar/PAN for secure transactions." },
    { title: "Ultrasonic Cleaning", desc: "Free cleaning to ensure the weight measured is the metal’s true weight." },
    { title: "XRF Purity Check", desc: "German XRF Karatmeter provides a precise breakdown with 99.9% accuracy." },
    { title: "Instant Payout", desc: "Payment via UPI, IMPS, RTGS, or Cash within 20 minutes." }
  ];
  ...
  const nearbyAreas = ["Hayathnagar", "BN Reddy Nagar", "L.B. Nagar", "Mansoorabad", "Sahara States"];

  const faqs = [
    {
      question: "I will get a better price if I go to the shop where I bought it?",
      answer: "This is rarely true. Most jewelers deduct 'wastage' and 'making charges'. SGold pays based on the International Market Value, often resulting in a higher payout."
    },
    {
      question: "Selling gold is a sign of financial failure?",
      answer: "On the contrary, selling gold is a smart asset reallocation. Using 'dead gold' for high-growth investments or clearing high-interest debt is a wise financial move."
    },
    {
      question: "The purity of my gold will decrease if it is tested?",
      answer: "Only if you use old 'melting' or 'rubbing' methods. Our Laser XRF testing is 100% non-destructive. Your jewelry remains exactly as it was."
    },
    {
      question: "Do you buy '916 Hallmark' gold?",
      answer: "Yes, we buy all types of gold, including hallmark and non-hallmark jewellery, based on its precise purity and current market rates."
    }
  ];
  ...
  return (
    <main className="min-h-screen bg-background text-text-primary">
      ...
      <section className="relative px-6 py-20 lg:px-8">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          <p className="text-sm font-semibold uppercase tracking-[0.25em] text-brand-gold">
            Locations: Vanasthalipuram
          </p>
          <h1 className="mt-6 text-4xl font-bold leading-tight tracking-tight text-text-primary lg:text-5xl">
            Sell Gold in Vanasthalipuram – <br />
            <span className="bg-gradient-to-r from-[#F6E7A1] via-[#E9C962] to-[#D4AF37] bg-clip-text text-transparent">
              Secure, Transparent & High-Value Cash.
            </span>
          </h1>
          <p className="mt-6 text-lg text-text-secondary">
            The trusted choice for Vanasthalipuram’s residential community. We offer a professional, high-tech alternative to the unorganized gold-buying market.
          </p>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              In a community of long-term residents, trust is the most important currency. SGold sets a new standard of transparency, offering non-destructive testing and private cabins for your comfort.
            </p>
          ...
          <div className="rounded-[2.5rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
            <h3 className="text-2xl font-bold text-text-primary">The SGold Advantage</h3>
            <div className="mt-8 space-y-6">
              {[
                "Laser XRF Technology (Non-destructive)",
                "Private and comfortable valuation cabins",
                "Professional, high-tech environment",
                "City-best rates for Vijayawada Highway entry",
      ...
      <section className="bg-[var(--color-section-bg)] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-text-primary">Comprehensive Gold Services</h2>
            <p className="mt-4 text-text-secondary">We respect the heritage of your family assets.</p>
          </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-text-primary">Our 5-Step Integrity Process</h2>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl font-bold text-text-primary">Serving Greater Vanasthalipuram</h2>
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              Our branch is the central hub for residents of Hayathnagar, Abdullapurmet, BN Reddy Nagar, L.B. Nagar, Mansoorabad, and Sahara States.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="rounded-[3rem] border border-card-border bg-card-bg p-8 shadow-2xl backdrop-blur-xl lg:p-12">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              <h2 className="text-3xl font-bold text-text-primary">Visit SGold Vanasthalipuram</h2>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-text-tertiary">
                      # 5-5-303, Plot No. 136, Ground Floor, Vanasthalipuram, Hyderabad. <br />
                      <strong>Landmark:</strong> Next to Tupperware Shop, Opp. to Vijaya Diagnostic Center
                    </p>
                  </div>
                </div>
            ...
            <div className="h-[400px] overflow-hidden rounded-[2rem] border border-card-border shadow-inner">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3808.123456789012!2d78.5812345!3d17.3312345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDIwJzQwLjQiTiA3OMKwMzQnNDAuNCJF!5e0!3m2!1sen!2sin!4v1713360000000!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
      ...
      {/* FAQ Section */}
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <h2 className="text-3xl font-bold text-center text-text-primary mb-12">FAQs – Selling Gold in Vanasthalipuram</h2>
