          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            <div className="fade-up">
              ...
              <div className="mt-6 space-y-6 text-lg leading-8 text-text-secondary">
                ...
                <p>
                  SGold is the best jewellery buyer in Hyderabad that can help you to release pledged gold and
              ...
              <div className="flex flex-col gap-8">
                <div>
                  ...
                  <p className="mt-4 text-base leading-7 text-text-secondary">
                    SGold attaches extreme importance towards customer gratification and this helps us in
